...
hero:
  ...
  actions:
    - text: Read the Spec
      ...
      variant: primary
    - text: View on GitHub
      link: https://github.com/KDust7/heliumSpec
      variant: minimal
      icon: external
---
